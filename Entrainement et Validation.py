...
img = cv2.imread('Data\Images\image_cropped.png')
...
labeled_img = cv2.imread('Data\Masks\masque_cropped.png')
...
plt.imsave('image_segmentee_bigger.png', segmented, cmap ='jet')
